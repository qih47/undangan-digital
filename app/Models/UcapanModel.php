...
class UcapanModel extends Model
{
    ...
    protected $allowedFields = ['id_invitation', 'nama', 'lokasi', 'kehadiran', 'ucapan',];

    public function getWithInvitation()
    {
        return $this->select('kirim_doa.id as id_ucapan,kirim_doa.nama AS pengirim,kirim_doa.lokasi AS lokasi,kirim_doa.kehadiran,kirim_doa.ucapan,kirim_doa.time_created, invitation.*')
